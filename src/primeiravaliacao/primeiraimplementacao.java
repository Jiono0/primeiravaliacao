 ...
 * @author mateus
 */
public class primeiraimplementacao extends Primeiravaliacao {
    ...
    void limpa() {
        JOptionPane.showMessageDialog(null, "Resultado da soma limpo!!");
    }

    void entrarprograma() {
        JOptionPane.showMessageDialog(null, "Voce esta somando!!");
    }

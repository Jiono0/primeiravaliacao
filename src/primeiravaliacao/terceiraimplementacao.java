 ...
 * @author mateus
 */
public class terceiraimplementacao extends Primeiravaliacao {
    ...
    void limpa() {
        JOptionPane.showMessageDialog(null, "Resultado da multiplicacao limpo!!");
    }

    void entrarprograma() {
        JOptionPane.showMessageDialog(null, "Voce esta multiplicando!!");
    }
